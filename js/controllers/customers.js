...
customerController.$inject = ['$scope', '$http', '$timeout', '$window','$log','$rootScope'];
		function customerController($scope, $http, $timeout,$window,$log,$rootScope) {
	...
	customerListController.$inject = ['$scope', '$http', '$timeout', '$window','$log', '$rootScope'];
